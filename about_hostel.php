  ...
  <style>
    ...
    * {
    ...
    @media screen and (max-width: 768px) {
      ...
      .AboutColumn:nth-child(1) {
        grid-area: col1;
      }

      .AboutColumn:nth-child(2) {
        grid-area: col2;
      }
...
<body>
    ...
    <div class="container header-container">
      ...
      <div class="login-dropdown">
        ...
        <div class="login-dropdown-content" id="loginDropdown">
          ...
          <a href="https://tdbcollege.in/student_login.aspx" class="login-option"><i class="fas fa-user-graduate"></i>
            College Student Login</a>
        </div>
      </div>
  ...
  <!-- Add this section below your existing InfoContainer sections -->
  <div class="AboutContainer" id="about-section">
    <div class="AboutWrapper">
      <!-- Big Heading -->
      <h1 class="AboutHeading">About Our Hostel</h1>

      <!-- Hostel Details Section -->
      <div class="AboutRow">
        <div class="AboutColumn">
          <div class="AboutTextWrapper">
            <h2 class="AboutSubHeading">Hostel Facilities</h2>
            <ul class="AboutList">
              <li class="AboutListItem">40 well-furnished rooms</li>
              <li class="AboutListItem">Total intake capacity of 80 students</li>
              <li class="AboutListItem">24/7 security and CCTV surveillance</li>
              <li class="AboutListItem">High-speed WiFi connectivity</li>
              <li class="AboutListItem">Spacious common areas and study rooms</li>
              <li class="AboutListItem">Regular cleaning and maintenance</li>
              <li class="AboutListItem">Nutritious and hygienic meals</li>
              <li class="AboutListItem">Indore/Outdoor play facilities available</li>
            </ul>
          </div>
        </div>
        <div class="AboutColumn">
          <div class="AboutImgWrap">
            <img class="AboutImg" src="images/hostel.jpg" alt="Hostel Building">
          </div>
        </div>
      </div>

      <!-- Admission Procedure Section -->
      <div class="AboutProcedure">
        <h2 class="AboutSubHeading">Admission Procedure</h2>
        <div class="ProcedureSteps">
          <div class="ProcedureStep">
            <div class="StepNumber">1</div>
            <div class="StepContent">
              <h3>College Admission</h3>
              <p>First, complete your admission process in the college.</p>
            </div>
          </div>
          <div class="ProcedureStep">
            ...
            <div class="StepContent">
              ...
              <p>Within one week of college admission, apply for hostel accommodation.</p>
            </div>
          </div>
          <div class="ProcedureStep">
            ...
            <div class="StepContent">
              <h3>Payment</h3>
              <p>Complete the payment process at the college cash counter.</p>
            </div>
          </div>
          <div class="ProcedureStep">
            ...
            <div class="StepContent">
              <h3>Allocation</h3>
              <p>Room allocation will be done based on availability.</p>
            </div>
          </div>
        </div>
        <div class="ContactInfo">
          <p>For any queries regarding hostel admission, please contact:</p>
          <p><strong>Hostel Warden:</strong> +91 XXXXX XXXXX</p>
          <p><strong>College Cash Counter:</strong> 9:00 AM - 4:00 PM (Monday to Saturday)</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="footer-container">
        <div class="footer-col">
          ...
          <p>Block C was more than just a building - it was our home for those formative college years where lifelong
            friendships were forged.</p>
        ...
        <div class="footer-col">
          ...
          <a href="#" class="btn"
            style="display: inline-block; margin-top: 15px; padding: 8px 20px; font-size: 0.9rem;">Get Updates</a>
        </div>
      </div>
